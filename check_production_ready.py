...
def run_checks():
    ...
    if os.path.exists(main_py):
        with open(main_py, "r", encoding="utf-8", errors="ignore") as f_obj:
            content = f_obj.read()
    ...
    if os.path.exists(dockerfile):
        with open(dockerfile, "r", encoding="utf-8", errors="ignore") as f_obj:
            content = f_obj.read()
            results.append(check("Multi-stage build",
                                 "as builder" in content.lower()))
    ...
    if os.path.exists(dockerignore):
        with open(dockerignore, "r", encoding="utf-8", errors="ignore") as f_obj:
            content = f_obj.read()
    ...
    if pct == 100:
        print("  PRODUCTION READY! Deploy nao!")
    elif pct >= 80:
